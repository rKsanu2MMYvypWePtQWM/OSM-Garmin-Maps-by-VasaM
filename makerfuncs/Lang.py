class LangClass:
	...
	cs = {
		...
		'Area ID: ': 'ID oblasti: ',
		'Can\'t download map data!': 'Nelze stahnout mapova data!',
		'Can\'t open file ': 'Nelze otevrit soubor ',
		...
		'Invalid bat file name': 'Neplatne jmeno bat souboru',
		'Make ': 'Vytvarim ',
		'file': 'soubor',
